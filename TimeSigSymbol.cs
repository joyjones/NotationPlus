    ...
    public class TimeSigSymbol : MusicSymbol
    {
        ...
        private static void LoadImages()
        {
            if (images == null)
            {
                ...
                images[2] = Resources.two;// new Bitmap(typeof(TimeSigSymbol), "images/two.png");
                images[3] = Resources.three;//new Bitmap(typeof(TimeSigSymbol), "images/three.png");
                images[4] = Resources.four;//new Bitmap(typeof(TimeSigSymbol), "images/four.png");
                images[6] = Resources.six;//new Bitmap(typeof(TimeSigSymbol), "images/six.png");
                images[8] = Resources.eight;//new Bitmap(typeof(TimeSigSymbol), "images/eight.png");
                images[9] = Resources.nine;//new Bitmap(typeof(TimeSigSymbol), "images/nine.png");
                images[12] = Resources.twelve;//new Bitmap(typeof(TimeSigSymbol), "images/twelve.png");
            }
        }
