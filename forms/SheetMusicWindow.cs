...
namespace NotationPlus
{
     ...
     *
     *   Open Sample Song
     *     Open one of the sample midi files that comes with NotationPlus.
     *
     *   Close 
     ...
     * Help
     *   Contents
     *     Display a text area describing the NotationPlus options.
     */
    public class SheetMusicWindow : Form
    {
        ...
        void OpenSampleSong(object obj, EventArgs args)
        {
            ...
            if (sampleSongDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                string resourceName = "NotationPlus.songs." + name + ".mid";
        ...
        void About(object obj, EventArgs args)
        {
            ...
            Icon icon = Properties.Resources.NotePairIcon;// new Icon(GetType(), "NotePair.ico");
        ...
        void Help(object obj, EventArgs args)
        {
            ...
            Assembly assembly = this.GetType().Assembly;
            Stream stream = assembly.GetManifestResourceStream("NotationPlus.help.help.rtf");
