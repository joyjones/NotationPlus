...
namespace NotationPlus
{
    ...
    public class MidiPlayer : Panel
    {
        ...
        private void loadButtonImages()
        {
            ...
            rewindImage = new Bitmap(Resources.rewind, imagesize);
            playImage = new Bitmap(Resources.play, imagesize);
            pauseImage = new Bitmap(Resources.pause, imagesize);
            stopImage = new Bitmap(Resources.stop, imagesize);
            fastFwdImage = new Bitmap(Resources.fastforward, imagesize);
            volumeImage = new Bitmap(Resources.volume, imagesize);
        }
